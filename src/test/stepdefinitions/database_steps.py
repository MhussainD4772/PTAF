...
@keyword_step(parsers.parse('the database does not contain a record for query "{query_key}" with parameters "{params}"'))
...
@keyword_step(parsers.parse('I verify the database contains a record for query "{query_key}" with parameters "{params}"'))
...
@keyword_step(parsers.parse('I verify the database does not contain a record for query "{query_key}" with parameters "{params}"'))
...
@keyword_step(parsers.parse('I insert a new record using query "{query_key}" with parameters "{params}"'))
...
@keyword_step(parsers.parse('I update a record using query "{query_key}" with parameters "{params}"'))
...
@keyword_step(parsers.parse('I delete {expected_rows:d} records using query "{query_key}" with parameters "{params}"'))
