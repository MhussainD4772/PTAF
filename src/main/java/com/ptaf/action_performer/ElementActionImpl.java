...
public class ElementActionImpl extends PageHelper implements ElementAction {
     ...
     * This method is now the central orchestrator for locator chaining.
     * It parses locator strings with ">" to build complex, chained locators.
     *
     * @param iFrame, iFrame_2, iFrame_3, element, key, page, frameLocator
    ...
    public Locator getLocator(String iFrame, String iFrame_2, String iFrame_3, String element, String key, Page page, FrameLocator frameLocator) {
        ...
        try {
            // 1. Establish the initial context (the Page or a specific Frame)
            Object context = page;
            ...
            // 2. Iterate through the parts of the chain and build the final locator
            for (int i = 0; i < locatorParts.length; i++) {
                ...
                if (i == 0) {
                    // For the FIRST part, use the Page or FrameLocator as the context
                    ...
                    // For ALL OTHER parts, chain off the previous locator by calling our new overloaded method
