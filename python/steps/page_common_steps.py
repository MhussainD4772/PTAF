...
@then(
    parsers.re(
        r'^we enter value on page (.*?) locator (.*?) value "(.*?)"$'
    )
)
...
@then(
    parsers.re(
        r'^we clear value on page (.*?) locator (.*?) value "(.*?)"$'
    )
)
...
@then(
    parsers.re(r"^we verify on page (.*?) of locator (.*?) is visible$")
)
...
@then(
    parsers.re(r"^we verify on page (.*?) of locator (.*?) is checked$")
)
...
@then(
    parsers.re(r"^we verify on page (.*?) of locator (.*?) is enabled")
)
...
@then(
    parsers.re(r"^we verify on page (.*?) of locator (.*?) is existed")
)
...
@then(
    parsers.re(
        r'^we contain on page (.*?) of locator (.*?) value "(.*?)"$'
    )
)
...
@then(
    parsers.re(
        r'^we has value on page (.*?) of locator (.*?) value "(.*?)"$'
    )
)
...
@when(parsers.re(r"we click radio on page (.*?) list locator (.*?)$"))
...
@then(
    parsers.re(
        r'^we capture screenshot on page (.*?) locator (.*?) name "(.*?)"$'
    )
)
...
@then(
    parsers.re(
        r'^we press on page (.*?) locator (.*?) key "(.*?)" keyboard$'
    )
)
...
@then(parsers.re(r"^we click download on page (.*?) locator (.*?)$"))
