...
@then(parsers.re(r"^we click on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we double click on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we check on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we uncheck on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we hover on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we scroll on frame (.*?) locator (.*?)$"))
...
@then(parsers.re(r"^we get text on frame (.*?) locator (.*?)$"))
...
@when(parsers.re(r"we click radio on frame (.*?) list locator (.*?)$"))
